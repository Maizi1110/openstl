...
def load_data(dataname, batch_size, val_batch_size, num_workers, data_root, dist=False, **kwargs):
    ...
    # 鍦?__init__.py 鐨?build_dataloader 鍑芥暟閲屾坊鍔犺繖娈碉細
    elif 'cikm' in dataname.lower():
        from .dataloader_cikm2017 import load_data_cikm
        return load_data_cikm(batch_size, val_batch_size, data_root, num_workers, **cfg_dataloader)
