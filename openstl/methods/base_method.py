...
class Base_method(l.LightningModule):
    ...
    def __init__(self, **args):
        ...
        # =================================================================
        # 🚨 终极防崩溃装甲 (V2 修复版)：修复 None 变字符串的问题 🚨
        # =================================================================
        safe_args = {}
        for k, v in args.items():
            # 【关键修复】必须放过 None、list 和 tuple！否则优化器初始化会读取到错误格式！
            if v is None or isinstance(v, (int, float, str, bool, list, tuple, dict)):
                safe_args[k] = v
            else:
                safe_args[k] = str(v)

        self.save_hyperparameters(safe_args)
        # =================================================================
